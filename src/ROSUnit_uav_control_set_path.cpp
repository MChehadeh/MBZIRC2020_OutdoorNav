#include "ROSUnit_uav_control_set_path.hpp"

ROSUnit_uav_control_set_path::ROSUnit_uav_control_set_path(std::string t_name, ros::NodeHandle& t_main_handler) : ROSUnit(t_main_handler)
{
    m_client = t_main_handler.serviceClient<common_srv::set_poses>(t_name);
}

ROSUnit_uav_control_set_path::~ROSUnit_uav_control_set_path()
{

}

void ROSUnit_uav_control_set_path::receive_msg_data(DataMessage* t_msg)
{
